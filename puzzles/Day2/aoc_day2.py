...
def get_range_generator(fn: Path | str) -> Generator[str, None, None]:
    """Returns a generator for loading each ID range from the input file."""
...
def solve_puzzle1():
    """Solves part 1 of AoC Day 2"""
    id_ranges = get_range_generator(Path(sys.path[0]) / "input.txt")
